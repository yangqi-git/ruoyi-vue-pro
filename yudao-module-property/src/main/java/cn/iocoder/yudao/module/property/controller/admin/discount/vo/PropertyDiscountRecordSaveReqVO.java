...
@Schema(description = "管理后台 - 优惠记录创建/更新 Request VO")
@Data
public class PropertyDiscountRecordSaveReqVO {
    ...
    @Schema(description = "优惠单号", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "优惠单号不能为空")
    ...
    @Schema(description = "优惠类型", requiredMode = Schema.RequiredMode.REQUIRED)
